...
#define ADC_SAR_SEQ_DEFAULT_VREF_SEL               (3u)
...
#define ADC_SAR_SEQ_DEFAULT_VREF_MV_VALUE          (1024)
#define ADC_SAR_SEQ_DEFAULT_BUFFER_GAIN            (0u)
#define ADC_SAR_SEQ_DEFAULT_AVG_SAMPLES_NUM        (4u)
#define ADC_SAR_SEQ_DEFAULT_AVG_SAMPLES_DIV        (int16)(0x100u >> (7u - 4u))
...
#define ADC_SAR_SEQ_DEFAULT_EN_CHANNELS            (15u)
#define ADC_SAR_SEQ_NOMINAL_CLOCK_FREQ             (1846154)
...
#define ADC_SAR_SEQ_CHANNELS_MODE                  (30u)
