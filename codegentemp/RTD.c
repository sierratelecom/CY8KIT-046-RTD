...
#if (CY_PSOC3)
{
    ...
    ***************************************/
    const int32 CYCODE RTD_coeffPos[] = { -50557706, 256068436, 43930833, 16049961, 3928075, 6996227 };
    const int32 CYCODE RTD_coeffNeg[] = { -1573870, 8185835, -3915208, 44686880, -155910685, 203019134 };
